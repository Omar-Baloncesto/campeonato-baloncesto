...
// Block layout: row 1 = blank, then 17 rows per team (title + 2 header rows + 12 player rows + 2 blank)
//   Block 1 (Miami Heat)  : team title row 2, headers rows 3-4, players rows 5-16, blank 17-18
//   Block 2 (Brooklyn)    : team title row 19, headers 20-21, players 22-33, blank 34-35
//   Block 3 (Boston)      : 36-37-38, players 39-50, blank 51-52
//   Block 4 (OKC)         : 53-54-55, players 56-67, blank 68-69
//   Block 5 (Lakers)      : 70-71-72, players 73-84, blank 85-86
//   Block 6 (Raptors)     : 87-88-89, players 90-101
//
...
//   AH (33)    = Suma P3      (green)
//   AI (34)    = Subtotal     (brick)

const SPREADSHEET_ID = '1JF2vVbrnMYTMC3WrOVVv-vkTICBxh06S0t-40cyPIo0';

// Fetch from the browser using Google's gviz/tq endpoint — no API key needed.
// headers=0 ensures ALL rows (including row 1) appear in the data array so that
// rows[i] === sheet row (i+1), matching the 1-based playerRowStart/End config.
...
// Colors matching the Apps Script exactly
const C = {
