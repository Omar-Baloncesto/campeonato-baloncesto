...
// Actual block layout (15 rows per team, no leading blank row):
//   title row  + 1 header row + 12 player rows + 1 blank row  = 15 rows/block
//   Miami Heat       : title=1,  header=2,  players=3-14,  blank=15
//   Brooklyn Nets    : title=16, header=17, players=18-29, blank=30
//   Boston Celtics   : title=31, header=32, players=33-44, blank=45
//   OKC Thunder      : title=46, header=47, players=48-59, blank=60
//   Los Angeles Lakers: title=61, header=62, players=63-74, blank=75
//   Toronto Raptors  : title=76, header=77, players=78-89, blank=90
//
...
const EQUIPOS_CONFIG = [
  { nombre: 'Miami Heat',            playerRowStart: 3,  playerRowEnd: 14  },
  { nombre: 'Brooklyn Nets',         playerRowStart: 18, playerRowEnd: 29  },
  { nombre: 'Boston Celtics',        playerRowStart: 33, playerRowEnd: 44  },
  { nombre: 'Oklahoma City Thunder', playerRowStart: 48, playerRowEnd: 59  },
  { nombre: 'Los Angeles Lakers',    playerRowStart: 63, playerRowEnd: 74  },
  { nombre: 'Toronto Raptors',       playerRowStart: 78, playerRowEnd: 89  },
];
